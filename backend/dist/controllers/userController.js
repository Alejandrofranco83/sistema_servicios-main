...
const createInitialAdmin = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Verificar si ya existe un administrador
        const adminExists = yield userRepository.findOne({
            where: { role: 'ADMIN' }
        });
        if (adminExists) {
        ...
        admin.password = yield bcrypt.hash('admin123', 10);
