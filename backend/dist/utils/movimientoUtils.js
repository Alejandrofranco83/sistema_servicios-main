...
function mapearMoneda(moneda) {
    ...
    if (moneda === 'GUARANIES' || moneda === 'GS' || moneda === 'PYG')
        return 'guaranies';
    if (moneda === 'DOLARES' || moneda === 'USD')
        return 'dolares';
    if (moneda === 'REALES' || moneda === 'BRL')
        return 'reales';
    // Valor por defecto
    return moneda;
}
 ...
 */
function registrarMovimiento(_a) {
    return __awaiter(this, arguments, void 0, function* ({ operacionId, moneda, monto, esIngreso, concepto, usuarioId, usoDevolucionId }) {
        ...
        try {
            ...
            const ultimoMovimiento = yield db.query(`SELECT * FROM caja_mayor_movimientos 
       WHERE moneda = $1 
       ...
       LIMIT 1`, [moneda]);
            ...
            const result = yield db.query(`INSERT INTO caja_mayor_movimientos (
 ...
 */
function registrarMovimientoUsoDevolucion(_a) {
    return __awaiter(this, arguments, void 0, function* ({ id, tipo, guaranies, dolares, reales, persona_nombre, usuario_id }) {
        ...
        try {
            ...
            if (guaranies && guaranies > 0) {
                ...
                const movimientoGuaranies = yield registrarMovimiento({
                    operacionId: id,
                    moneda: 'guaranies',
                    monto: guaranies,
            ...
            if (dolares && dolares > 0) {
                ...
                const movimientoDolares = yield registrarMovimiento({
                    operacionId: id,
                    moneda: 'dolares',
                    monto: dolares,
            ...
            if (reales && reales > 0) {
                ...
                const movimientoReales = yield registrarMovimiento({
                    operacionId: id,
                    moneda: 'reales',
                    monto: reales,
...
//# sourceMappingURL=movimientoUtils.js.map