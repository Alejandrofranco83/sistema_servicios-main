...
const wepaUsdController = require('../controllers/wepaUsdController');
...
module.exports = function(authMiddleware) {
  ...
  router.get('/actual', authMiddleware, wepaUsdController.getCurrentConfig);

  // Obtener historial de configuraciones
  router.get('/historial', authMiddleware, wepaUsdController.getConfigHistory);
  ...
  router.post('/',
    ...
    wepaUsdController.createConfig
  );

  // Descargar contrato
  router.get('/:id/contrato', authMiddleware, wepaUsdController.downloadContrato);
